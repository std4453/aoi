...
import { HardDrive, Server, Tag } from 'lucide-react';
      ...
      <div className="space-y-3">
        ...
        <div className="bg-gray-900 rounded-xl p-4 border border-gray-800">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between text-sm">
              <span className="text-gray-400">上传协议</span>
              <span className="text-white">tus (分片断点续传)</span>
            </div>
            <div className="flex items-center justify-between text-sm">
              <span className="text-gray-400">支持格式</span>
              <span className="text-white">ZIP, RAR</span>
            </div>
            <div className="flex items-center justify-between text-sm">
              <span className="text-gray-400">最大上传</span>
        ...
        >
          ...
          <span className="text-sm text-gray-500">{tagCount}</span>
        </button>
      </div>
    </div>
  );
